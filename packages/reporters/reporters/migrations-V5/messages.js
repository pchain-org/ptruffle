    ...
    const kinds = {
      ...
      deployed: () => {
        ...
        output +=
          ...
          `   > ${"value sent:".padEnd(20)} ${data.value} PI\n` +
          `   > ${"total cost:".padEnd(20)} ${data.cost} PI\n`;
      ...
      postMigrate: () => {
        ...
        output +=
          self.underline(37) +
          "\n" +
          `   > ${"Total cost:".padEnd(15)} ${data.cost.padStart(15)} PI\n`;
      ...
      lastMigrate: () => {
        ...
        output +=
          ...
          `> ${"Final cost:".padEnd(20)} ${data.finalCost} PI\n`;
